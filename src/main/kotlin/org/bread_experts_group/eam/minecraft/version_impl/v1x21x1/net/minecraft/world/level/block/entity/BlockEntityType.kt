...
import org.bread_experts_group.eam.minecraft.version_impl.v1x21x1.NativeConstantsV1x21x1.com_mojang_datafixers_types_Type
...
import org.bread_experts_group.eam.minecraft.version_impl.v1x21x1.NativeConstantsV1x21x1.net_minecraft_world_level_block_entity_BlockEntityType_Builder
...
# {"fileName":"BlockEntityType.java","id":"sourceFile"}
	...
	class Builder(around: Any) : MimickedClass(around) {
		...
		fun build(): BlockEntityType = BlockEntityType(
			clazz.getMethod("a", loadClass(com_mojang_datafixers_types_Type))
				.invoke(around, null)
		)
	}
}