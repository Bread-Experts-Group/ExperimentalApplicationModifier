...
import org.bread_experts_group.eam.minecraft.version_impl.v1x21x1.NativeConstantsV1x21x1.net_minecraft_client_renderer_MultiBufferSource
import org.bread_experts_group.eam.minecraft.version_impl.v1x21x1.NativeConstantsV1x21x1.net_minecraft_client_renderer_MultiBufferSource_BufferSource
 ...
 */
open class MultiBufferSource(around: Any) : MimickedClass(around) {
    ...
    90:101:void endBatch(net.minecraft.client.renderer.RenderType,com.mojang.blaze3d.vertex.BufferBuilder) -> a
	 */
	class BufferSource(around: Any) : MultiBufferSource(around) {
		companion object : ClassInfo {
			override val clazz: Class<*> = loadClass(net_minecraft_client_renderer_MultiBufferSource_BufferSource)
			override val classDesc: ClassDesc = clazz.classDesc
			override val mimicClassDesc: ClassDesc = BufferSource::class.classDesc
		}

		fun endBatch(renderType: RenderType) {
			clazz.getMethod("a", RenderType.clazz)
				.invoke(around, renderType.around)
		}
	}
}