...
import org.bread_experts_group.eam.minecraft.version_impl.v1x21x1.NativeConstantsV1x21x1.net_minecraft_world_level_block_Blocks
...
/*
    ...
    60:60:java.util.function.Function waterloggedMapColor(net.minecraft.world.level.material.MapColor) -> a
    64:64:java.lang.Boolean never(net.minecraft.world.level.block.state.BlockState,net.minecraft.world.level.BlockGetter,net.minecraft.core.BlockPos,net.minecraft.world.entity.EntityType) -> a
    68:68:java.lang.Boolean always(net.minecraft.world.level.block.state.BlockState,net.minecraft.world.level.BlockGetter,net.minecraft.core.BlockPos,net.minecraft.world.entity.EntityType) -> b
    72:72:java.lang.Boolean ocelotOrParrot(net.minecraft.world.level.block.state.BlockState,net.minecraft.world.level.BlockGetter,net.minecraft.core.BlockPos,net.minecraft.world.entity.EntityType) -> c
    76:76:net.minecraft.world.level.block.Block bed(net.minecraft.world.item.DyeColor) -> a
    80:80:net.minecraft.world.level.block.Block log(net.minecraft.world.level.material.MapColor,net.minecraft.world.level.material.MapColor) -> a
    84:84:net.minecraft.world.level.block.Block log(net.minecraft.world.level.material.MapColor,net.minecraft.world.level.material.MapColor,net.minecraft.world.level.block.SoundType) -> a
    88:88:net.minecraft.world.level.block.Block netherStem(net.minecraft.world.level.material.MapColor) -> b
    92:92:boolean always(net.minecraft.world.level.block.state.BlockState,net.minecraft.world.level.BlockGetter,net.minecraft.core.BlockPos) -> a
    96:96:boolean never(net.minecraft.world.level.block.state.BlockState,net.minecraft.world.level.BlockGetter,net.minecraft.core.BlockPos) -> b
    100:100:net.minecraft.world.level.block.Block stainedGlass(net.minecraft.world.item.DyeColor) -> b
    104:104:net.minecraft.world.level.block.Block leaves(net.minecraft.world.level.block.SoundType) -> a
    108:108:net.minecraft.world.level.block.Block shulkerBox(net.minecraft.world.item.DyeColor,net.minecraft.world.level.material.MapColor) -> a
    ...
    129:129:net.minecraft.world.level.block.Block candle(net.minecraft.world.level.material.MapColor) -> c
    ...
    1244:1244:int lambda$static$54(net.minecraft.world.level.block.state.BlockState) -> a
    1243:1243:int lambda$static$53(net.minecraft.world.level.block.state.BlockState) -> b
    1238:1238:int lambda$static$52(net.minecraft.world.level.block.state.BlockState) -> c
    1237:1237:int lambda$static$51(net.minecraft.world.level.block.state.BlockState) -> d
    1236:1236:int lambda$static$50(net.minecraft.world.level.block.state.BlockState) -> e
    1094:1094:int lambda$static$49(net.minecraft.world.level.block.state.BlockState) -> f
    1090:1090:boolean lambda$static$48(net.minecraft.world.level.block.state.BlockState,net.minecraft.world.level.BlockGetter,net.minecraft.core.BlockPos) -> c
    1090:1090:int lambda$static$47(net.minecraft.world.level.block.state.BlockState) -> g
    1072:1072:int lambda$static$46(net.minecraft.world.level.block.state.BlockState) -> h
    1071:1071:int lambda$static$45(net.minecraft.world.level.block.state.BlockState) -> i
    1070:1070:int lambda$static$44(net.minecraft.world.level.block.state.BlockState) -> j
    1069:1069:int lambda$static$43(net.minecraft.world.level.block.state.BlockState) -> k
    1003:1003:int lambda$static$42(net.minecraft.world.level.block.state.BlockState) -> l
    1002:1002:int lambda$static$41(net.minecraft.world.level.block.state.BlockState) -> m
    961:961:int lambda$static$40(net.minecraft.world.level.block.state.BlockState) -> n
    941:941:int lambda$static$39(net.minecraft.world.level.block.state.BlockState) -> o
    940:940:int lambda$static$38(net.minecraft.world.level.block.state.BlockState) -> p
    875:875:int lambda$static$37(net.minecraft.world.level.block.state.BlockState) -> q
    873:873:int lambda$static$36(net.minecraft.world.level.block.state.BlockState) -> r
    757:757:boolean lambda$static$35(net.minecraft.world.level.block.state.BlockState,net.minecraft.world.level.BlockGetter,net.minecraft.core.BlockPos,net.minecraft.world.entity.EntityType) -> d
    757:757:int lambda$static$34(net.minecraft.world.level.block.state.BlockState) -> s
    756:756:boolean lambda$static$33(net.minecraft.world.level.block.state.BlockState,net.minecraft.world.level.BlockGetter,net.minecraft.core.BlockPos,net.minecraft.world.entity.EntityType) -> e
    753:753:int lambda$static$32(net.minecraft.world.level.block.state.BlockState) -> t
    741:741:int lambda$static$31(net.minecraft.world.level.block.state.BlockState) -> u
    625:625:int lambda$static$30(net.minecraft.world.level.block.state.BlockState) -> v
    501:501:int lambda$static$29(net.minecraft.world.level.block.state.BlockState) -> w
    493:493:int lambda$static$28(net.minecraft.world.level.block.state.BlockState) -> x
    487:487:int lambda$static$27(net.minecraft.world.level.block.state.BlockState) -> y
    485:485:int lambda$static$26(net.minecraft.world.level.block.state.BlockState) -> z
    484:484:int lambda$static$25(net.minecraft.world.level.block.state.BlockState) -> A
    482:482:int lambda$static$24(net.minecraft.world.level.block.state.BlockState) -> B
    479:479:int lambda$static$23(net.minecraft.world.level.block.state.BlockState) -> C
    478:478:int lambda$static$22(net.minecraft.world.level.block.state.BlockState) -> D
    414:414:int lambda$static$21(net.minecraft.world.level.block.state.BlockState) -> E
    412:412:int lambda$static$20(net.minecraft.world.level.block.state.BlockState) -> F
    411:411:int lambda$static$19(net.minecraft.world.level.block.state.BlockState) -> G
    410:410:int lambda$static$18(net.minecraft.world.level.block.state.BlockState) -> H
    409:409:int lambda$static$17(net.minecraft.world.level.block.state.BlockState) -> I
    397:397:boolean lambda$static$16(net.minecraft.world.level.block.state.BlockState,net.minecraft.world.level.BlockGetter,net.minecraft.core.BlockPos,net.minecraft.world.entity.EntityType) -> f
    396:396:boolean lambda$static$15(net.minecraft.world.level.block.state.BlockState,net.minecraft.world.level.BlockGetter,net.minecraft.core.BlockPos) -> d
    324:324:net.minecraft.world.level.block.entity.BlockEntityType lambda$static$14() -> c
    321:321:int lambda$static$13(net.minecraft.world.level.block.state.BlockState) -> J
    320:320:int lambda$static$12(net.minecraft.world.level.block.state.BlockState) -> K
    319:319:int lambda$static$11(net.minecraft.world.level.block.state.BlockState) -> L
    318:318:int lambda$static$10(net.minecraft.world.level.block.state.BlockState) -> M
    308:308:int lambda$static$9(net.minecraft.world.level.block.state.BlockState) -> N
    180:180:int lambda$static$8(net.minecraft.world.level.block.state.BlockState) -> O
    112:112:boolean lambda$pistonBase$7(net.minecraft.world.level.block.state.BlockState,net.minecraft.world.level.BlockGetter,net.minecraft.core.BlockPos) -> e
    88:88:net.minecraft.world.level.material.MapColor lambda$netherStem$6(net.minecraft.world.level.material.MapColor,net.minecraft.world.level.block.state.BlockState) -> a
    84:84:net.minecraft.world.level.material.MapColor lambda$log$5(net.minecraft.world.level.material.MapColor,net.minecraft.world.level.material.MapColor,net.minecraft.world.level.block.state.BlockState) -> a
    80:80:net.minecraft.world.level.material.MapColor lambda$log$4(net.minecraft.world.level.material.MapColor,net.minecraft.world.level.material.MapColor,net.minecraft.world.level.block.state.BlockState) -> b
    76:76:net.minecraft.world.level.material.MapColor lambda$bed$3(net.minecraft.world.item.DyeColor,net.minecraft.world.level.block.state.BlockState) -> a
    60:60:net.minecraft.world.level.material.MapColor lambda$waterloggedMapColor$2(net.minecraft.world.level.material.MapColor,net.minecraft.world.level.block.state.BlockState) -> b
    56:56:int lambda$litBlockEmission$1(int,net.minecraft.world.level.block.state.BlockState) -> a
    49:52:boolean lambda$static$0(net.minecraft.world.level.block.state.BlockState,net.minecraft.world.level.BlockGetter,net.minecraft.core.BlockPos) -> f
...
class Blocks(around: Any) : MimickedClass(around) {
	companion object : ClassInfo {
		...
		fun register(id: String, block: Block): Block = Block(
			clazz
				.getMethod("a", String::class.java, Block.clazz)
				.invoke(null, id, block.around)
		)
	}
}