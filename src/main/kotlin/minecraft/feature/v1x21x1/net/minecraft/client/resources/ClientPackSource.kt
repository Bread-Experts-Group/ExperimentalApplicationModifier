...
import org.bread_experts_group.eam.minecraft.feature.v1x21x1.net.minecraft.server.packs.repository.RepositorySource
...
class ClientPackSource(around: Any) : BuiltInPackSource(around) {
	companion object {
		val clazz: Class<*> = loadClass(net_minecraft_client_resources_ClientPackSource)
	}
