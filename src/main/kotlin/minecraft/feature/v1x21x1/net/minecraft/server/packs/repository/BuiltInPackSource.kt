...
import org.bread_experts_group.eam.minecraft.feature.v1x21x1.net_minecraft_server_packs_repository_BuiltInPackSource
...
open class BuiltInPackSource(around: Any) : RepositorySource(around) {
	companion object {
		val clazz: Class<*> = loadClass(net_minecraft_server_packs_repository_BuiltInPackSource)
	}
}